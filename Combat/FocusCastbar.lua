...
function FC:CreateFrame()
    ...
    local frame = CreateFrame("Frame", "KE_FocusCastbarFrame", parent, "BackdropTemplate")
...
function FC:RegWithEditMode()
    if KE.EditMode and not self.editModeRegistered then
        KE.EditMode:RegisterElement({
            key = "FocusCastbar", displayName = "Focus Castbar", frame = self.frame,
