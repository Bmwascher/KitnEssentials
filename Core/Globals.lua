...
local PREVIEW_MODULES = {
    ...
    "NoMovementAlert", "PrescienceTracker", "GreatVaultAlert", "PotionReady", "BossDebuffs", "AuraExternals", "AuraDebuffs",
...
local SECTION_PREVIEW_MODULES = {
    combat_section = {
        "CombatRes", "BossDebuffs", "AuraExternals", "AuraDebuffs", "CombatTexts", "CombatTimer",
