...
agent_skills/evals/tools/run_trigger_evals.py — unmodified except this
provenance header and explicit utf-8 encoding on both open() calls (Windows
defaults to cp1252). See LICENSE-THIRD-PARTY.md in this directory.
