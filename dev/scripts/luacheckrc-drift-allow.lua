...
return {
    missing_ok = {
        ...
        PlaySoundFile = "C-side global absent from the 12.1.0 API docs AND the full UI-source scan (same class as LootSlotHasItem -- Blizzard's own UI plays sounds via PlaySound soundkit ids); /run-verified function (type probe) 12.1.0 2026-08-11 (Modules/Combat/FocusCastbar.lua:200)",
