...
return {
    missing_ok = {
        ...
        ERR_INV_FULL = "GlobalStrings.lua constant, not in the UI-source export (same class as ROLL_DISENCHANT) (Modules/QoL/Automation.lua)",
        ERR_QUEST_LOG_FULL = "GlobalStrings.lua constant, not in the UI-source export (Modules/QoL/Automation.lua)",
        ERR_RAID_GROUP_ONLY = "GlobalStrings.lua constant, not in the UI-source export (Modules/QoL/Automation.lua)",
        ERR_PARTY_LFG_BOOT_LIMIT = "GlobalStrings.lua constant, not in the UI-source export (Modules/QoL/Automation.lua)",
        ERR_PARTY_LFG_BOOT_DUNGEON_COMPLETE = "GlobalStrings.lua constant, not in the UI-source export (Modules/QoL/Automation.lua)",
        ERR_PARTY_LFG_BOOT_IN_COMBAT = "GlobalStrings.lua constant, not in the UI-source export (Modules/QoL/Automation.lua)",
        ERR_PARTY_LFG_BOOT_IN_PROGRESS = "GlobalStrings.lua constant, not in the UI-source export (Modules/QoL/Automation.lua)",
        ERR_PARTY_LFG_BOOT_LOOT_ROLLS = "GlobalStrings.lua constant, not in the UI-source export (Modules/QoL/Automation.lua)",
        ERR_PARTY_LFG_TELEPORT_IN_COMBAT = "GlobalStrings.lua constant, not in the UI-source export (Modules/QoL/Automation.lua)",
        ERR_PET_SPELL_DEAD = "GlobalStrings.lua constant, not in the UI-source export (Modules/QoL/Automation.lua)",
        ERR_PLAYER_DEAD = "GlobalStrings.lua constant, not in the UI-source export (Modules/QoL/Automation.lua)",
        SPELL_FAILED_TARGET_NO_POCKETS = "GlobalStrings.lua constant, not in the UI-source export (Modules/QoL/Automation.lua)",
        ERR_ALREADY_PICKPOCKETED = "GlobalStrings.lua constant, not in the UI-source export (Modules/QoL/Automation.lua)",
        ERR_PARTY_LFG_BOOT_NOT_ELIGIBLE_S = "GlobalStrings.lua constant, not in the UI-source export (format string; Modules/QoL/Automation.lua)",
    },
    unused_ok = {
