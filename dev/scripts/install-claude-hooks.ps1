...
# agents-mirror, references-check and retention-check hooks depend on this
# repo's scripts, so
...
$scopes = @(
    ...
    @{ label = 'project'; hooks = @('agents-mirror-sync.ps1', 'references-check.ps1', 'retention-check.ps1')
