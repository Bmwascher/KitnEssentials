...
describe("DropdownSearchMatches", function()
    ...
    it("matches everything on an empty or nil query", function()
        assert.is_true(KE.DropdownSearchMatches("Peon Ready", "PeonReady", ""))
        assert.is_true(KE.DropdownSearchMatches("Peon Ready", "PeonReady", nil))
    end)
    ...
    it("matches numeric keys through tostring", function()
        assert.is_true(KE.DropdownSearchMatches(nil, 14, "1"))
    end)
end)
