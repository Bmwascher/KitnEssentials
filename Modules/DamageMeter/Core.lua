...
-- Every one of the player's casts lands here, so the spell test is first and
-- nothing may be added above it. The event is not a restricted callback (no
-- HasRestrictions, no CallbackEvent).
