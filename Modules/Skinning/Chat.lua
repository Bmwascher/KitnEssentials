...
function CHAT:UpdateDB()
    ...
    -- Published for ChatCopy.lua, which cannot see a file-local here. Kept in
    -- lockstep on the next line so a font change reaches both.
    self.cachedFontPath = cachedFontPath
