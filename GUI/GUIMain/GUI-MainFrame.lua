...
GUIFrame.sidebarConfig = {
    ...
    },
    {
        ...
        items = {
            ...
            { id = "SecondaryStats",    text = "Secondary Stats", keywords = { "secondary stats", "stats", "stat", "crit", "critical strike", "haste", "mastery", "versatility", "vers", "leech", "lifesteal", "avoidance", "speed", "rating", "percent", "readout", "display" } },
