-- ╔══════════════════════════════════════════════════════════╗
-- ║  GUI-KEScrollbar.lua                                     ║
-- ║  Purpose: Custom slider-based scrollbar with theme       ║
-- ║  colors, pixel-snapped thumb, mouse wheel handler.       ║
-- ║  Replaces UIPanelScrollFrameTemplate manual styling.     ║
-- ╚══════════════════════════════════════════════════════════╝
...
local KEScrollbarMixin = {}

function KEScrollbarMixin:UpdateVisibility(contentHeight, frameHeight)
...
function KEScrollbarMixin:ApplyThemeColors()
...
function KE.GUI.CreateScrollbar(scrollFrame, options)
    options = options or {}
    ...
    local pixelStep = KE:PixelBestSize()
    ...
    -- Pixel snapping prevents scrollbar jiggle on fractional values
    ...
    Mixin(scrollbar, KEScrollbarMixin)
